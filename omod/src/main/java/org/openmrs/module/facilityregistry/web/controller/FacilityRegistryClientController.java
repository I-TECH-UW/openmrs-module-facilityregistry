 ...
 */
package org.openmrs.module.facilityregistry.web.controller;
 ...
 */
@Controller("${rootrootArtifactid}.FacilityRegistryClientController")
@RequestMapping(value = "module/${rootArtifactid}/${rootArtifactid}.form")
public class FacilityRegistryClientController {
